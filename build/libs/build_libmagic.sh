...
build_libmagic() (
  ...
  file_archive="file-${file_version}.tar.gz"
  file_url="ftp://ftp.astron.com/pub/file/${file_archive}"
  curl -sLo "${file_archive}" "${file_url}"
  common::extract "${file_archive}" "${LIBMAGIC_BUILD_DIR}"
