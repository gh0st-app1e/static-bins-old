...
LIBMPFR_VERSION="4.2.2"
LIBMPFR_ARCHIVE="mpfr-${LIBMPFR_VERSION}.tar.xz"
LIBMPFR_URL="https://www.mpfr.org/mpfr-current/${LIBMPFR_ARCHIVE}"
...
build_libmpfr() (
  curl -sLo "${LIBMPFR_ARCHIVE}" "${LIBMPFR_URL}"
  common::extract "${LIBMPFR_ARCHIVE}" "${LIBMPFR_BUILD_DIR}"
